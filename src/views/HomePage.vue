<template>
  <div
    class="flex bg-center justify-center py-32 bg-fixed text-white"
  ...
  <div></div>
  <!-- Partys -->
  <div class="flex bg-center justify-center py-8 text-white">
    ...
    <div class="grid grid-cols-1 text-center">
      ...
      <div class="grid grid-cols-4 gap-4 py-9">
        <div v-for="album in items">
          <ReleaseComponent
            :title="album.name"
            :artists="getArtistNames(album.artists)"
            :streamlink="album.external_urls.spotify"
  ...
  <!-- questions -->
  <div
    class="flex bg-center justify-center p-24 bg-fixed bg-[url('/backgrounds/background1.jpg')] text-white">
